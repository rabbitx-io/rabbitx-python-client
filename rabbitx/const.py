TESTNET_URL = 'https://api.testnet.rabbitx.io'
WS_TESTNET_URL = 'wss://api.testnet.rabbitx.io/ws'
DEV_URL = 'https://api.dev.rabbitx.io'
WS_DEV_URL = 'wss://api.dev.rabbitx.io/ws'
URL = 'https://api.prod.rabbitx.io'
WS_URL = 'wss://api.prod.rabbitx.io/ws'
